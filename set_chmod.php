...
$no=$_GET['no'];
 ...
 ?>
         ...
         <div class="form-group">
          ...
          <!-- 
         <div class="form-group">
                  <label for="menu3" class="col-sm-3 control-label">Menu Pelanggan & Penawaran</label>
                  <div class="col-sm-9">
...
<!-- 
  ...
  $menu11 = $_POST['menu11'];
        ...
        if(isset($_POST['simpan'])){
           ...
           $sql1 = "update chmenu set menu1='$menu1', menu2='$menu2', menu3='$menu3', menu4='$menu4', menu5='5', menu6='$menu6', menu7='5', menu8='$menu8',menu9='$menu9',menu10='$menu10',menu11='$menu11' where userjabatan = '$userjabatan'";
