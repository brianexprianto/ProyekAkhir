...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Detail Pembelian | Kode Barang: #<?php echo $sku;?></h3>
            </div>
                                <!-- /.box-header -->
...
<!-- Profile Image -->
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php custom_echo( $nama,50);?></h3>

              <p class="text-muted text-center"><?php custom_echo( $nama_supplier,50);?></p>
...
<div class="box-body col-md-6">
               ...
               $sql    = "select s.*,t.* from stok_masuk_daftar s join stok_masuk t on s.nota = t.nota where s.kode_barang = '$kode'";
    ...
    ?>        
                ...
                $sql=mysqli_query($conn,"SELECT s.*,t.* FROM stok_masuk_daftar s join stok_masuk t on s.nota = t.nota where 
                  s.kode_barang = '$kode' ");
                    ...
                    while($fill=mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td>'.$no_urut++.'</td>';
                        echo '<td>'.$fill['tglmasuk'].'</td>';
                        echo '<td>'.$fill['jumlah'].'</td>';
                        echo '<td> Rp '.number_format($fill['biaya_pesan']).'</td>';


                      
                          echo '<td>'.$fill['lead_time'].' hari </td>';
                        echo '<td>'.$fill['supplier'].'</td>';
