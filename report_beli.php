...
<div class="box" id="tabel1">
 ...
 <?php
    ...
    $sql    = "select *, supplier.nama as supplier from buy inner join supplier on supplier.kode = buy.supplier WHERE buy.tglsale BETWEEN '" . $dr . "' AND  '" . $sam . "' order by buy.no desc";
  } else {
