...
<div class="col-xs-12">
    <div class="box">
        ...
        <div class="box-body">
            <p>
               <!--  <a href="histori_persediaan" class='btn btn-success btn-sm' > Histori Pembelian</a> &nbsp -->
    ...
    ?>        
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 100px">Sisa <br> Stok</th>
                        <th>Jumlah Order <br> Ekonomis (EOQ)</th>
                        <th>Titik Pemesanan <br> Kembali (ROP)</th>
                       
                        <th>Safety <br> Stock</th>
                        <th>Frekuensi <br>Pemesanan</th>
                        <th>Aksi</th>
                ...
                $sql=mysqli_query($conn,"SELECT * FROM barang ORDER BY no");
                   ...
                   <?php    
                        ...
                        echo '<td>'.$fill['sisa'].'</td>';
                        echo '<td>'.$fill['eoq'].'</td>';
                        echo '<td>'.$fill['stokmin'].'</td>';

                      
                          echo '<td>'.$fill['safety_stok'].'</td>';
                            echo '<td>'.$fill['frekuensi'].'</td>';
                              ?>
                            
          <td><button type="button" class="btn btn-info btn-xs" onclick="window.location.href='persediaan_detail?no=<?php echo $fill['no']?>'">Detail</button></td>
           <?php 
